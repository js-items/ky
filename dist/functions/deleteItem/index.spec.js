        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, index_1.default(__assign({}, testConfig_1.config, { createFilter: createFilterMock, deleteItemOptions: function () { return ({ searchParams: { pretty: 'true' } }); }, ky: function () { return Promise.resolve(kyMock); } }))({
                            filter: filter,
                            id: testItem_1.default.id,
                        })];
                case 1:
