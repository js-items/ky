...
describe('@deleteItem', function () {
    it('deletes item with no filter', function () { return __awaiter(_this, void 0, void 0, function () {
        var deleteMock;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(deleteMock).toBeCalledWith("test/" + testItem_1.default.id, {
    ...
    it('deletes item with filter and custom search params', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, index_1.default(__assign({}, testConfig_1.config, { createFilter: createFilterMock, deleteItemOptions: function () { return ({ searchParams: { pretty: 'true' } }); }, ky: function () { return Promise.resolve({ delete: deleteMock }); } }))({
                            filter: filter,
                            id: testItem_1.default.id,
                        })];
                case 1:
                    ...
                    expect(deleteMock).toBeCalledWith(testConfig_1.config.itemUrl + "/" + testItem_1.default.id, {
    ...
    it('does not delete item', function () { return __awaiter(_this, void 0, void 0, function () {
