    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    connection = _c.sent();
                    options = config.replaceItemOptions(__assign(__assign({}, item), { id: id }));
                    ...
                    return [4 /*yield*/, connection
                            .put(config.itemUrl + "/" + id, __assign(__assign({}, options), { json: __assign(__assign({}, item), json), searchParams: __assign(__assign({}, searchParams), params) }))
                            .json()];
                case 2:
                    response = _c.sent();
