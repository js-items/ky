...
exports.default = (function (config) { return function (_a) {
    var _b = _a.filter, filter = _b === void 0 ? {} : _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    searchParams = !isNil_1.default(options) && !isNil_1.default((options).searchParams)
                        ...
                        : {};
                    return [4 /*yield*/, connection.delete(config.itemUrl, __assign(__assign({}, options), { searchParams: __assign(__assign({}, searchParams), params) }))];
                case 2:
                    _c.sent();
                    return [3 /*break*/, 4];
                case 3:
